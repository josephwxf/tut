...
# prefix on Windows
if(MSVC)
		set(PROTOBUFC_ORIG_FIND_LIBRARY_PREFIXES "${CMAKE_FIND_LIBRARY_PREFIXES}")
    set(CMAKE_FIND_LIBRARY_PREFIXES "lib" "")

	find_path(PROTOBUFC_SRC_ROOT_FOLDER protobuf.pc.in)
endif()
...
find_program(PROTOBUFC_PROTOC_EXECUTABLE
    ...
    PATHS
	${PROTOBUFC_SRC_ROOT_FOLDER}/vsprojects/Release
	${PROTOBUFC_SRC_ROOT_FOLDER}/vsprojects/Debug
)
